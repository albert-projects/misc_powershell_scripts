...
$scan_time = Get-Date -Format "dd/MM/yyyy HH:mm"
...
$pwd = "<Password>"
$table = "<Table Name>"
$ServerInstance = "<DB Server>\SQLEXPRESS"

Get-InstalledSoftware | Select-Object -Property ComputerName, Name, Version, Installdate, UninstallCommand | Write-SqlTableData -ServerInstance $ServerInstance -DatabaseName $SQLDBName -SchemaName "dbo" -TableName $table -Force


#$queryStr = "INSERT INTO " + $table +  "( Scan_Datatime, ComputerName, SoftwareName, Version, InstallDate, UninstallCommand, Enable ) VALUES ( '" + $ComputerTarget + "', '" + $ComputerName  + "', '" + $MacAddress + "', '" + $ServiceTag + "');"  
